...
from interp_ema import interpolation, interpolation_model_load
...
def interpolation_ema_api(info, res_json):
    ...
    try:
        ...
        resolve_relative_path('moudel_fuction/moudel_reference_fuction/interpolation/ema/model/ckpt/ours_t.pkl'))
