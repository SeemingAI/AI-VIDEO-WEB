...
from .typings import VideoMemoryStrategy, FaceSelectorMode, FaceAnalyserOrder, FaceAnalyserAge, FaceAnalyserGender, FaceMaskType, FaceMaskRegion, TempFrameFormat, OutputVideoEncoder, OutputVideoPreset
import numpy

def create_metavar(ranges):
	return '[' + str(ranges[0]) + '-' + str(ranges[-1]) + ']'


def create_int_range(start, stop , step) :
