...
from utils.moudel_utils.interpolation.ema.config import config as cfg
from utils.moudel_utils.interpolation.ema.config.interpolation_ema import Model
from utils.moudel_utils.interpolation.ema.config.padder import InputPadder

from utils.utils.frame_to_video_ffmpeg import np_to_mp4,extract_frames
from utils.utils.file_process import resolve_relative_path,create_temp, clear_temp
from utils.utils.tools import split_filename, download_file

from utils.utils.tools import input_file
...
def interpolation(video_path, output_dir,model, rate, fps=0):
    ...
    np_to_mp4(output_path, images, fps = output_fps)
...
if __name__ == "__main__":
    ...
    "插帧"
    interp_video_path = interpolation(video_path="/root/test3.mp4",output_dir = "/root/seeming-sim-linux/core/example"
                                      ,model=model, rate=2)
